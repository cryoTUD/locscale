...
def get_threshold_analysis_data(parent_folder, EMDB_PDB_ids,output_filename, process_id=None):
    ...
    for emdb_pdb in EMDB_PDB_ids:
        ...
        try:
            ...
            pdf_file.savefig(unsharp_plot_xy)
            pdf_file.savefig(sharp_plot_xy)
            pdf_file.savefig(unsharp_surface_fig)
            pdf_file.savefig(sharp_surface_fig)
        except:
