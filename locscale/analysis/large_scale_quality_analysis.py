...
def run_locscale_script(parent_folder, EMDB_PDB_ids, fsc_resolutions_list,output_filename, process_id=None):
    parent_folder = "/mnt/c/Users/abharadwaj1/Downloads/ForUbuntu/LocScale/tests/test_quality_metrics_large"
    output_folder = "/mnt/c/Users/abharadwaj1/Downloads/ForUbuntu/LocScale/tests/test_quality_metrics_large"

    locscale_script = os.environ("LOCSCALE_PATH")
    ...
    for emdb_pdb in EMDB_PDB_ids:
        ...
        try:
            ...
            symmetry = extract_symmetry(emdb_id)
...
if __name__ == "__main__":
    ...
    for i in range(processes):
        ...
        output_filename = "quality_analysis_process_{}".format(i)
