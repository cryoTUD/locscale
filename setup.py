...
setup(name='locscale',
    ...
    install_requires=['matplotlib>=3.3.4','biopython>=1.78','numpy>=1.20.0','scipy>=1.5.4','pandas>=1.1.5',\
                      'mrcfile>=1.3.0','gemmi>=0.4.8','pypdb>=2.0','sklearn>=0.0','pwlf>=2.0.4','tqdm>=4.62.3',\
                      'more_itertools>=8.10.0','servalcat>=0.2.23','tensorflow==2.7','tensorflow-addons==0.14.0',\
                      'keras==2.7.0','tensorflow_datasets==4.5.2','pyfiglet>=0.8.post1', 'wget>=3.2', 'locscale'],
