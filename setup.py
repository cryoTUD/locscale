...
setup(name='locscale',
    ...
    install_requires=['numpy>=1.19.5','scipy>=1.5.4','pandas>=1.1.5','mrcfile>=1.3.0','gemmi>=0.4.8','pypdb>=2.0','sklearn>=0.0','pwlf>=2.0.4','tqdm>=4.62.3','proshade>=0.7.6','emda>=1.1.3','more_itertools>=8.10.0'],
    entry_points={
      'console_scripts': [
