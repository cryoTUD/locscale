...
class test_compute_scaling(unittest.TestCase):
    ...
    def test_scaling(self):
        from locscale.utils.scaling_tools import compute_radial_profile_proper, compute_scale_factors, set_radial_profile
        ...
        for i in [1,2,3]:
            ...
            rp_emmap_test,_ = compute_radial_profile_proper(emmap_window, self.frequency_map_window)
            rp_modmap_test, frequencies_map = compute_radial_profile_proper(modmap_window, self.frequency_map_window)
    ...
    def test_scaling_random(self):
        ...
        for i in range(100):
            ...
            rp_emmap_window, _ = compute_radial_profile_proper(emmap_window, self.frequency_map_window)
            
            rp_modmap_window, frequencies_map = compute_radial_profile_proper(modmap_window, self.frequency_map_window)
            ...
            rp_scaled_map_old,_ = compute_radial_profile_proper(scaled_map_old_inside, self.frequency_map_window)
            rp_scaled_map_new,_ = compute_radial_profile_proper(scaled_map_new_inside, self.frequency_map_window)
